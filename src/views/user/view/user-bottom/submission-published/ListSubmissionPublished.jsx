...
const ListSubmissionPublished = props => {
    ...
    <Card>
      <CardContent className='flex flex-col gap-6'>
        ...
        {dataAPI.total > 0 ? (
                  ...
                  <div className='flex flex-col gap-4 p-5'>
                    ...
                    <div className='flex flex-col gap-1'>
                      <Typography
                        variant='h5'
                        component={Link}
                        href={getLocalizedUrl(`submission/detail/${item.Paper.id}`, locale)}
          ...
          <Typography className='text-center'>Data tidak ditemukan</Typography>
        )}
        <div className='flex justify-center'>
          <Pagination
            count={Math.ceil(dataAPI.total / page)}
            page={activePage + 1}
            showFirstButton
            showLastButton
            variant='tonal'
...
export default ListSubmissionPublished
